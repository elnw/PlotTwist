...
class PlaceAdapter(var places: ArrayList<String>, val context: Context): RecyclerView.Adapter<PlaceAdapter.ViewHolder>()  {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val titleTextView = view.placeTextView
        val placeLayout = view.placeLayout


        fun updateFrom(place: String) {
            titleTextView.text= place
            placeLayout.setOnClickListener { view ->
               val context = view.context
                context.startActivity( Intent(context, StoriesActivity::class.java).putExtra("location",place))
            }
